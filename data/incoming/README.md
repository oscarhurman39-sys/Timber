...
| `toxicity-2026-09-16-batch2.json` | 11 applied | Batch 2 of the toxicity backfill, verbatim. 25 asked, 11 sourced, 14 deliberately blank. Carries the deck's first **HTA category B** (`Ginkgo biloba`) — which tiers identically to a category C on the card, because the ladder reads wording and not the sourced classification. See VQ 91. |
